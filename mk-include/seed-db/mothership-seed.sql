...
n1	minikube	local	local	local	{"zones": [{"id": "minikube", "name": "a"}], "docker_repo": "minikube"}	2017-06-22 13:50:29.53859	2017-06-22 13:50:29.53859
n2	vpc-958feff3	aws	us-west-2	devel	{"zones": [{"id": "us-west-2a", "name": "a"}, {"id": "us-west-2b", "name": "b"}, {"id": "us-west-2c", "name": "c"}], "docker_repo": "037803949979.dkr.ecr.us-west-2.amazonaws.com"}	2017-06-22 13:50:29.53859	2017-06-22 13:50:29.53859
n3	vpc-eff08497	aws	us-west-2	devel	{"zones": [{"id": "us-west-2a", "name": "a"}], "docker_repo": "037803949979.dkr.ecr.us-west-2.amazonaws.com"}	2017-06-22 13:50:29.53859	2017-06-22 13:50:29.53859
\.
...
--
-- Name: users users_email_key; Type: CONSTRAINT; Schema: deployment; Owner: caas
--
...
--
-- Name: logical_cluster logical_cluster_account_id_name_unique; Type: CONSTRAINT; Schema: deployment; Owner: caas
--

ALTER TABLE ONLY logical_cluster
    ADD CONSTRAINT logical_cluster_account_id_name_unique UNIQUE (account_id, name);
