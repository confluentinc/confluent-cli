...
func (s *CLITestSuite) TestConnectCommands() {
	...
	tests := []CLITest{
		...
		{args: "connector create --cluster lkc-123 --config test/fixtures/input/connector-config.yaml -o json", fixture: "connector-create-json.golden", wantErrCode: 0},
		{args: "connector create --cluster lkc-123 --config test/fixtures/input/connector-config.yaml -o yaml", fixture: "connector-create-yaml.golden", wantErrCode: 0},
